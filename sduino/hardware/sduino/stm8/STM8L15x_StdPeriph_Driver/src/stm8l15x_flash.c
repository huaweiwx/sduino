/**
  ...
  *
  ******************************************************************************
  * modifying for sdcc by huaweiwx@sina.com 2018.3.2
  */
...
void write_u32_address(uint32_t Address, uint32_t Data)
{
#ifndef _SDCC_
...
IN_RAM(void FLASH_EraseBlock(uint16_t BlockNum, FLASH_MemType_TypeDef FLASH_MemType))
{
  ...
  #endif
#else
	flashAdr = (startaddress + ((uint32_t)BlockNum * FLASH_BLOCK_SIZE)); 
#endif	 
  ...
  defined (STM8L05X_LD_VL) || defined (STM8L05X_MD_VL) || defined (STM8AL31_L_MD)
    ...
    *pwFlash = (uint32_t)0;  
  #else
    write_u32_address(flashAdr, 0);    // SDCC patch: required for far pointers	
  #endif
#elif defined (STM8L15X_HD) || defined (STM8L05X_HD_VL)
  #ifndef _SDCC_
  *pwFlash = (uint8_t)0;
