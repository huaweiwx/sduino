...
*/
#if defined(STM8L)
 IMPLEMENT_ISR(EXTI0_IRQHandler,INT_PORTA0) /* EXTI PIN0 */
 IMPLEMENT_ISR(EXTI1_IRQHandler,INT_PORTA1) /* EXTI PIN1 */
 IMPLEMENT_ISR(EXTI2_IRQHandler,INT_PORTA2) /* EXTI PIN2 */
 IMPLEMENT_ISR(EXTI3_IRQHandler,INT_PORTA3) /* EXTI PIN3 */
 IMPLEMENT_ISR(EXTI4_IRQHandler,INT_PORTA4) /* EXTI PIN4 */
 IMPLEMENT_ISR(EXTI5_IRQHandler,INT_PORTA5) /* EXTI PIN5 */
 IMPLEMENT_ISR(EXTI6_IRQHandler,INT_PORTA6) /* EXTI PIN6 */
 IMPLEMENT_ISR(EXTI7_IRQHandler,INT_PORTA7) /* EXTI PIN7 */
 IMPLEMENT_ISR(EXTIE_F_PVD_IRQHandler,INT_PORTE) /* EXTI PORTE/EXTI PORTF/PVD */

 #if defined(STM8L15X_HD)||defined(STM8L15X_MDP)||defined (STM8L05X_HD_VL)  /*huaweiwx*/
 IMPLEMENT_ISR(EXTIB_G_IRQHandler,INT_PORTB) /* EXTI PORTB / EXTI PORTG */
 IMPLEMENT_ISR(EXTID_H_IRQHandler,INT_PORTD) /* EXTI PORTD / EXTI PORTH */
 IMPLEMENT_ISR(TIM1_CC_IRQHandler,	INT_TIM1_CAPCOM)

 #elif (STM8L15X_MD) || defined (STM8L05X_MD_VL) || defined (STM8AL31_L_MD)
 IMPLEMENT_ISR(EXTIB_IRQHandler,INT_PORTB) /* EXTI PORTB / EXTI PORTG */
 IMPLEMENT_ISR(EXTID_IRQHandler,INT_PORTD) /* EXTI PORTD / EXTI PORTH */
 IMPLEMENT_ISR(TIM1_CC_IRQHandler,	INT_TIM1_CAPCOM)	

 #elif (STM8L15X_LD) || defined (STM8L05X_LD_VL)
 IMPLEMENT_ISR(EXTIB_IRQHandler,INT_PORTB) /* EXTI PORTB / EXTI PORTG */
 IMPLEMENT_ISR(EXTID_IRQHandler,INT_PORTD) /* EXTI PORTD / EXTI PORTH */

 #else
 #error "unsupport mcu serial"
 #endif
#elif defined(STM8S)
