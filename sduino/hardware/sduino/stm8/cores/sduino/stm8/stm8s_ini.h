...
void delay(uint16_t ms) /*LSI/LSE count*/
{
  for(;ms>0;ms--)
       __asm__("nop\n");
}
...
#if  defined(HSI)  
   #if (F_CPU == 16000000UL)
     #define CLK_SYSCLKDiv CLK_PRESCALER_CPUDIV1
   #elif (F_CPU == 8000000UL)	
     #define CLK_SYSCLKDiv CLK_PRESCALER_CPUDIV2
   #elif (F_CPU == 4000000UL)	
     #define CLK_SYSCLKDiv CLK_PRESCALER_CPUDIV4
   #elif (F_CPU == 2000000UL)	
     #define CLK_SYSCLKDiv CLK_PRESCALER_CPUDIV8
   #elif (F_CPU == 1000000UL)	
     #define CLK_SYSCLKDiv CLK_PRESCALER_CPUDIV16
   #else
...
#ifdef HSI
    CLK_SYSCLKConfig(CLK_SYSCLKDiv);
 // set the clock
#elif defined(HSE)
...
//    while (CLK_GetSYSCLKSource() != CLK_SYSCLKSource_HSE) {}
    ...
    GPIOE->CR2 = GPIO_CR2_RESET_VALUE; /* Reset Control Register 2 */
    GPIOE->ODR = GPIO_ODR_RESET_VALUE; /* Reset Output Data Register */
    GPIOE->DDR = GPIO_DDR_RESET_VALUE; /* Reset Data Direction Register */
    GPIOE->CR1 = GPIO_CR1_RESET_VALUE; /* Reset Control Register 1 */
	
    GPIOF->CR2 = GPIO_CR2_RESET_VALUE; /* Reset Control Register 2 */
    GPIOF->ODR = GPIO_ODR_RESET_VALUE; /* Reset Output Data Register */
    GPIOF->DDR = GPIO_DDR_RESET_VALUE; /* Reset Data Direction Register */
    GPIOF->CR1 = GPIO_CR1_RESET_VALUE; /* Reset Control Register 1 */
	
#if defined(GPIOG)
    GPIOG->CR2 = GPIO_CR2_RESET_VALUE; /* Reset Control Register 2 */
    GPIOG->ODR = GPIO_ODR_RESET_VALUE; /* Reset Output Data Register */
    GPIOG->DDR = GPIO_DDR_RESET_VALUE; /* Reset Data Direction Register */
    GPIOG->CR1 = GPIO_CR1_RESET_VALUE; /* Reset Control Register 1 */
#endif

#if defined(GPIOH)
    GPIOH->CR2 = GPIO_CR2_RESET_VALUE; /* Reset Control Register 2 */
    GPIOH->ODR = GPIO_ODR_RESET_VALUE; /* Reset Output Data Register */
    GPIOH->DDR = GPIO_DDR_RESET_VALUE; /* Reset Data Direction Register */
    GPIOH->CR1 = GPIO_CR1_RESET_VALUE; /* Reset Control Register 1 */
#endif
#if defined(GPIOI)
    GPIOI->CR2 = GPIO_CR2_RESET_VALUE; /* Reset Control Register 2 */
    GPIOI->ODR = GPIO_ODR_RESET_VALUE; /* Reset Output Data Register */
    GPIOI->DDR = GPIO_DDR_RESET_VALUE; /* Reset Data Direction Register */
    GPIOI->CR1 = GPIO_CR1_RESET_VALUE; /* Reset Control Register 1 */
#endif

//move to HardwareSerial.c
//  #if defined(UART1) 
//	UART1_DeInit();
//  #else
//	UART2_DeInit();
