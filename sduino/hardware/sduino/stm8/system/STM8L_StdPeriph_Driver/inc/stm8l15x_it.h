/**
  ...
  *
  ******************************************************************************
  Modify for sduino by huaweiwx@sina.com 2018.3.2
  */
...
//  void TRAP_IRQHandler(void)  __interrupt(TRAP_IRQn); /* TRAP */
//  void FLASH_IRQHandler(void)  __interrupt(FLASH_IRQn); /* FLASH EOP/PG_DIS */
//  void DMA1_CHANNEL0_1_IRQHandler(void)  __interrupt(DMA1_CHANNEL0_1_IRQn); /* DMA1 Channel0/1*/
//  void DMA1_CHANNEL2_3_IRQHandler(void)  __interrupt(DMA1_CHANNEL2_3_IRQn); /*DMA1 Channel2/3*/
  void EXTIE_F_PVD_IRQHandler(void)  __interrupt(EXTIE_F_PVD_IRQn); /*EXTI PORTE/EXTI PORTF/PVD*/
  void EXTI0_IRQHandler(void)  __interrupt(EXTI0_IRQn); /* EXTI PIN0 */
  void EXTI1_IRQHandler(void)  __interrupt(EXTI1_IRQn); /* EXTI PIN1 */
  void EXTI2_IRQHandler(void)  __interrupt(EXTI2_IRQn); /* EXTI PIN2 */
  void EXTI3_IRQHandler(void)  __interrupt(EXTI3_IRQn); /* EXTI PIN3 */
  void EXTI4_IRQHandler(void)  __interrupt(EXTI4_IRQn); /* EXTI PIN4 */
  void EXTI5_IRQHandler(void)  __interrupt(EXTI5_IRQn); /* EXTI PIN5 */
  void EXTI6_IRQHandler(void)  __interrupt(EXTI6_IRQn); /* EXTI PIN6 */
  void EXTI7_IRQHandler(void)  __interrupt(EXTI7_IRQn); /* EXTI PIN7 */
//  void ADC1_COMP_IRQHandler(void)  __interrupt(ADC1_COMP_IRQn); /*ADC1/COMP*/
//  void SPI1_IRQHandler(void)  __interrupt(SPI1_IRQn); /* SPI1 */
  void TIM4_UPD_OVF_TRG_IRQHandler(void)  __interrupt(TIM4_UPD_OVF_TRG_IRQn); /* TIM4 UPD/OVF/TRI */
#if defined (STM8L15X_MD) || defined (STM8L05X_MD_VL) || defined (STM8AL31_L_MD)
//  void RTC_IRQHandler(void)  __interrupt(RTC_IRQn); /* RTC /CSS_LSE */
//  void SWITCH_CSS_BREAK_DAC_IRQHandler(void)  __interrupt(SWITCH_CSS_BREAK_DAC_IRQn); /* Switch CLK/CSS/TIM1 Break/DAC */
...
//  void RTC_CSSLSE_IRQHandler(void)  __interrupt(RTC_CSSLSE_IRQn); /* RTC /CSS_LSE */
